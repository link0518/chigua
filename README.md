...
JX3 瓜田是一个前后端同仓的匿名社区应用，核心能力包括匿名投稿、评论互动、热门榜单、搜索收藏、队伍招募、举报治理、后台审核、角色 Wiki 和基础运维脚本。
...
- 队伍招募：匿名发布 DPS 心法与招募正文，按招募建立双方密聊，并支持双方同意后交换联系方式；招募发布 24 小时后会与关联密聊一同自动结束。
- 举报治理：帖子/评论举报、谣言举报、自动隐藏、封禁与限流。
- 后台管理：举报处理、招募治理、精华审核、帖子与评论治理、反馈、封禁、公告、系统设置、敏感词、审计日志、管理员权限。
...
| `/featured` | 当前公开精华帖子。 |
| `/favorites` | 当前访客的收藏列表。 |
| `/recruitment` | 匿名队伍招募广场、我的招募与密聊列表。 |
...
- 招募密聊与联系方式只绑定当前 canonical 身份；清除 Cookie、换浏览器或设备后无法找回。消息正文和联系方式服务端加密保存，后台只能通过具体举报查看有限证据。
