...
const ACTION_META: Record<string, { title: string; category: AuditCategory; riskLevel?: AuditRiskLevel }> = {
  ...
  post_feature_add: { title: '新增了精华帖子', category: 'content_review' },
  post_feature_remove: { title: '取消了精华帖子', category: 'content_review' },
  post_feature_request_approve: { title: '通过了精华申请', category: 'content_review' },
  post_feature_request_reject: { title: '驳回了精华申请', category: 'content_review' },
